                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      Offline GRP analizi — Adstock, Saturation, Reach, Optimal GRP
                    </p>
                  </div>
                </div>
              </button>
              <button
                onClick={() => onStandaloneTool('digital')}
                className="w-full text-left px-5 py-4 rounded-xl border bg-dark-card border-dark-border hover:border-blue-400 hover:bg-blue-500/5 transition-all group"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="font-medium text-sm text-slate-100 group-hover:text-blue-400 transition-colors">
